	...
	\label{sec:prototipos_alta}
		...
		\label{sec:prototipos_alta_2}
			...
			\begin{figure}[!htb]
				\centering
				\subfloat[Tela 4]{
					\includegraphics[width=5cm, height=7.6cm]{parteIVn}
					\label{alta4n}
				}
				\quad %espaco separador
				\subfloat[Tela 5]{
					\includegraphics[width=5cm, height=7.6cm]{parteVn}
					\label{alta5n}
				}
				\quad
				\subfloat[Tela 6]{
					\includegraphics[width=5cm, height=7.6cm]{parteVIn}
					\label{alta6n}
				}
				\quad
				\subfloat[Tela 8]{
					\includegraphics[width=5cm, height=7.6cm]{parteVIIIn}
					\label{alta8n}
				}
